...
Modifications by J Adams jfa63[at]duck[dot]com
 */
...
unsigned char*
SHA256(char* data)
{ // Changed return type from char pointer. 
    int strLen = strlen(data);
    SHA256_CTX ctx;
    // We need a uchar array for tiAES -jfa63
    ...
    SHA256Init(&ctx);
    SHA256Update(&ctx, (uchar*) data, strLen); // need to cast as uchar* -jfa63
